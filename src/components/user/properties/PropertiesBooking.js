...
// formik yapi kurallar
  const validationSchema = Yup.object({
    ...
    dropOffDate: Yup.string()
      ...
      .test(
        // y test kontrolu istedigin kontrolu yazarsin
        "date-time",
    ...
    expireDate: Yup.string()
      ...
      .test("month_check", "Enter a valid expire date (MM/YY)", (value) => {
        ...
        // y farkli kullanimi moment in format yazmadan
        ...
        <Container>
          <Row>
            <Col md={isCarAvailable ? 6 : 12}>
              {/* araba musaitse 6 boyut degilse 12 */}
              <FloatingLabel label="Pickup Location" className="mb-3">
                {/* rb form */}
                <Form.Control
                  type="text"
                  placeholder="Pickup Location"
                  // y label ile ayni yaptik ki disari tiklasak ta yine icine gelsin???
              ...
              <InputGroup className="mb-3">
                <FloatingLabel label="Pickup Date" className="flex-grow-1">
                  {/* Y className="flex-grow-1"=BULUNDUGU YERE KOMPLE BUYUTMEYE CALISIR  */}
                  <Form.Control
                    type="date"
                    // date onemli
                    min={moment().format("YYYY-MM-DD")}
                    // Y bugunun onceki tarihine gitmesin ayari moment()icinde bulundugumuz tarihi verir
              ...
              <InputGroup className="mb-3">
                {/* inputgrup rb ten ile tarih ve zaman i yanyana aldik */}
                ...
                <FloatingLabel label="Time">
                  <Form.Control
                    ...
                    onBlur={checkTheCarIsAvailable}
                  />
                  {/* y focusu kaybedince isleme gecsin */}
                  <Form.Control.Feedback type="invalid">
